...
@Component({
    selector: 'app-dash',
    templateUrl: './nested-bar-dash.component.html',
    styleUrls: ['./nested-bar-dash.component.css'],
})
export class NestedBarDashComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.dashService.getDash(3).then((dash) => {
            this.dash = dash;
